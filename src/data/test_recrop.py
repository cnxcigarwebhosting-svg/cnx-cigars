...
for img_path in crops[:5]: # Test on first 5
    ...
    if contours:
        ...
        print(f"{os.path.basename(img_path)} -> Cigar found: x={x}, y={y}, w={w}, h={h}")
        ...
        cv2.imwrite(img_path.replace(".jpg", "_test.jpg"), cropped)
    else:
        print(f"{os.path.basename(img_path)} -> No cigar found")
